...
export PATH=/home/twqc64/google-cloud-sdk/bin:${PATH}
...
bq -q --format=csv query --max_rows=1 --allow_large_results --destination_table="motorola.com:datasystems:mac.applaunch" --replace "`cat applaunch.bq`"
...
bq extract --noprint_header motorola.com:datasystems:mac.applaunch "gs://guru-examples/data/applaunch/1-*.csv,gs://guru-examples/data/applaunch/2-*.csv,gs://guru-examples/data/applaunch/3-*.csv,gs://guru-examples/data/applaunch/4-*.csv"
